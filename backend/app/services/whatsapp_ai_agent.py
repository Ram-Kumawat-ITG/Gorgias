...
{
  "action": "create_order | fetch_order | cancel_order | edit_order | fetch_customer | create_customer | update_customer | check_inventory | suggest_alternatives | ask_email | ask_order_number | ask_product | ask_variant | ask_quantity | ask_confirmation | ask_retention | accept_gift_card | ask_issue | ask_evidence | ask_action_type | create_ticket | approve_action | reject_action | show_menu | none",
...
  "order_status": "pending | confirmed | shipped | delivered | cancelled | null",

 

  "action_type": "refund | replace | return | cancel | null",
  "issue": "damaged | wrong_item | missing | changed_mind | late | other | null",
  "evidence_description": "string or null",
...
  "inventory_query": "string or null",
  "gift_card_code": "string or null",
  "ticket_id": "string or null",

 

  "message": "WhatsApp message shown to customer — ALWAYS required",

 

  "buttons": [
    { "label": "Display Label", "value": "machine_value" }
  ]
}
